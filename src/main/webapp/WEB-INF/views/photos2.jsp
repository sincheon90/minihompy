								...
								<c:forEach items="${photoComment1}" var="photoComment1" varStatus="status">
									<tr height="10">
										...
										<td width="10%" align="center" valign="top" style='max-height:16px'>
											...
											<button type="submit" onclick="javascript:void(window.open('./updCommentForm?page=${paging.nowPage}&num=${photoComment1.num}', '댓글 수정','width=300, height=400'))">
										...
										<td width="10%" align="center" valign="top" style='max-height:16px'>
											<form name="delCom" method="post" action="delComment">
												<input type="hidden" id="page" name="page" value="${paging.nowPage}" />
												<input type="hidden" name="num" value="${photoComment1.num}" />
								...
								<c:forEach items="${photoComment2}" var="photoComment1" varStatus="status">
									<tr height="10">									
										...
										<td width="10%" align="center" valign="top" style='max-height:16px'>
											...
											<button type="submit" onclick="javascript:void(window.open('./updCommentForm?page=${paging.nowPage}&num=${photoComment2.num}', '댓글 수정','width=300, height=400'))">
												<font face="굴림" style="font-size:9pt;">수정</font>
											</button>
								...
								<c:forEach items="${photoComment3}" var="photoComment1" varStatus="status">
									<tr height="10">
										...
										<td width="10%" align="center" valign="top" style='max-height:16px'>
											...
											<button type="submit" onclick="javascript:void(window.open('./updCommentForm?page=${paging.nowPage}&num=${photoComment3.num}', '댓글 수정','width=300, height=400'))">
												<font face="굴림" style="font-size:9pt;">수정</font>
											</button>
