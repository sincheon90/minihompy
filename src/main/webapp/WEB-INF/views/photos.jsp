			...
			<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
				...
				<table border="0" width="420" cellpadding="1" cellspacing="1" align="center">
					<tr>
						...
						<td align="right"><input type="submit" value="사진인화"
								onclick="javascript:alert('아직 서비스중이지 않습니다.')"> <input type="button" value="사진올리기"
													...
													<tr height="10">
														...
														<td  valign="top">
															<c:if test="${photoComment1.num ne null && photoComment1.num ne '0'}">
																<font face="굴림" style="font-size:9pt;"><font color="#9C92FF">${photoComment1.writer} :</font> ${photoComment1.comment}</font>
															</c:if>
														</td>
