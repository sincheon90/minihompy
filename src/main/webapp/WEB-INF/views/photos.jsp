...
<form name="poto">
	...
	<table border="0" bgcolor="#EBEBEB" width="420" cellpadding="1" cellspacing="1" align="center">
		<tr>
			<td>
				<a name="n8"></a>
				<font face="굴림" style="font-size:9pt;"><b>008 - 김태희 사진8</b></font>
			</td>
		</tr>
	</table>
	<table border="0" align="center" width="420" cellpadding="1" cellspacing="1">
		<tr>
			<td width="100">  
				<font face="굴림" style="font-size:9pt;">장인수</font>
			</td>
			<td align="right">  
				<font face="굴림" style="font-size:9pt;">스크랩 : 5</font>
			</td>
		</tr>
		<tr>
			<td colspan="2" align="center">  
				<!-- 사진 바꾸기 -->
				<a href="../pics/9.jpg" target="_blank"> <img src="../pics/9.jpg" width="400" height="300" border="0" alt=""></a>
				<!-- --------- -->
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" align="center">  
				...
				<table border="0" width="400" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td align="right"> 
							<img src="../images/bar.jpg" width="420" height="6" border="0" alt=""><br/>
							<font face="굴림" style="font-size:9pt;">
	...
	<table border="0" bgcolor="#EBEBEB" width="420" cellpadding="1" cellspacing="1" align="center">
		<tr>
			<td>
				<a name="n7"></a>
				<font face="굴림" style="font-size:9pt;"><b>007 - 김태희 사진7</b></font>
			</td>
		</tr>
	</table>
	<table border="0" align="center" width="420" cellpadding="1" cellspacing="1">
		<tr>
			...
			<td align="right">  
				<font face="굴림" style="font-size:9pt;">스크랩 : 1</font>
			</td>
		</tr>
		<tr>
			<td colspan="2" align="center">  
				<!-- 사진 바꾸기 -->
				<a href="../pics/8.jpg" target="_blank"><img src="../pics/8.jpg" width="400" height="300" border="0" alt=""></a>
				<!-- --------- -->
			</td>
		</tr>
		<tr>
	...
	<table border="0" bgcolor="#EBEBEB" width="420" cellpadding="1" cellspacing="1" align="center">
		<tr>
			<td>
				<a name="n6"></a>
				<font face="굴림" style="font-size:9pt;"><b>006 - 김태희 사진6</b></font>
			</td>
		</tr>
	</table>
	<table border="0" align="center" width="420" cellpadding="1" cellspacing="1">
		<tr>
			...
			<td align="right">  
				<font face="굴림" style="font-size:9pt;">스크랩 : 3</font>
			</td>
		</tr>
		<tr>
			<td colspan="2" align="center">  
				<!-- 사진 바꾸기 -->
				<a href="../pics/7.jpg" target="_blank"><img src="../pics/7.jpg" width="400" height="300" border="0" alt=""></a>
				<!-- --------- -->
			</td>
		</tr>
		<tr>
